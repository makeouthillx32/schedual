// app/dashboard/[id]/settings/thememaker/_components/CSSThemeImporter.tsx
...
export const CSSThemeImporter: React.FC<CSSThemeImporterProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-start justify-center p-4 z-[100] pt-[100px] overflow-y-auto">
      <div className="bg-card border border-border rounded-lg w-full max-w-2xl my-4 overflow-hidden flex flex-col max-h-[calc(100vh-120px)]">
        {/* Header */}
