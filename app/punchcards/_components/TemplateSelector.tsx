...
const TemplateSelector: React.FC<TemplateSelectorProps> = ({
  ...
  // Mock templates - replace with Supabase query later
  useEffect(() => {
    const mockTemplates: Template[] = [
      {
        id: '1',
        name: 'Classic Punch Card',
        path: 'classic-punch-card.png',
        category: 'vintage',
        description: 'Traditional punch card design'
      },
      {
        id: '2',
        name: 'Modern Digital',
        path: 'modern-punch-card.png',
        category: 'modern',
